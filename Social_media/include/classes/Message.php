...
class Message {
	...
	public function getMessages($otherUser){
		...
		while ($row=mysqli_fetch_array($get_messages_query)) {
			...
			$div_top = ($user_to == $userLoggedIn) ? "<div class='message' id='grey'>" : "<div class='message' id='green'>";
	...
	public function getConvos() {
		...
		foreach($convos as $username) {
			...
			$return_string .= "<a href='messages.php?u=$username'> <div class='user_found_messages'>
								...
								<span class='timestamp_smaller' id='black'> " . $latest_message_details[2] . "</span>
								<p id='black' style='margin: 0;'>" . $latest_message_details[0] . $split . " </p>
								</div>
								</a>";
		}

...
***********************************************************/	
	...
	//Set Upload directory    
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/Social_media/assets/images/profile_pic';
	//Set File name	
...
<div class="upload_column">
	...
	<div id="formExample">
	    ...
	    <form action="upload.php" method="post"  enctype="multipart/form-data">
	        Upload Image<br /><br />
	        <input type="file" id="image" name="image" style="width:200px; height:30px; " /><br /><br /><br />	
	        <input type="submit" value="Post" style="width:120px; height:45px;"/>
	    </form><br /><br />
    ...
    if($imgSrc){ //if an image has been uploaded display cropping area?>
	    ...
	    <div id="CroppingContainer" style="width: 550px;max-height: 600px;background-color: #FFF;margin-left: -68px;position: relative;overflow: hidden;border: 2px #666 solid;z-index: 2001; padding-bottom:0px;">  
	    
	        <div id="CroppingArea" style="width:500px; max-height:600px; position:relative; overflow:hidden; margin:40px 0px 40px 40px; border:2px #666 solid; float:left;">	
	        ...
	        <div id="CropImageForm" style="width:100px; height:30px; float:left; margin:10px 0px 0px 40px;" >  
	            <form action="upload.php" method="post" onsubmit="return checkCoords();">
	                ...
	                <input type="hidden" value="<?=$src?>" name="src" /><br>
	               <center><input type="submit" value="Save" style="width:100px; height:30px; margin:10px;"/></center> 
	            </form>
	        </div>

	        <div id="CropImageForm2" style="width:100px; height:30px; float:left; margin:10px 0px 0px 40px;" >  
	            <form action="upload.php" method="post" onsubmit="return cancelCrop();"><br>
	                <center><input type="submit" value="Cancel Crop" style="width:100px; height:30px;  margin:10px;"/></center>
	            </form>
	        </div>            
